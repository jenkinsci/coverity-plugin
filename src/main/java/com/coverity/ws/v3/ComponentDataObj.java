 ...
 *       &lt;sequence>
 *         &lt;element name="componentId" type="{http://ws.coverity.com/v3}componentIdDataObj"/>
 *         &lt;element name="excludeComponent" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         &lt;element name="groupPermissions" type="{http://ws.coverity.com/v3}groupPermissionDataObj" maxOccurs="unbounded"/>
...
public class ComponentDataObj {
    ...
    protected boolean excludeComponent;
    @XmlElement(required = true)
    ...
    /**
     * Sets the value of the excludeComponent property.
     * 
     */
    public void setExcludeComponent(boolean value) {
        this.excludeComponent = value;
    }
