    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.coverity.ws.v5.DefectServiceService.class.getName());
    ...
    public DefectServiceService() {
        super(DEFECTSERVICESERVICE_WSDL_LOCATION, new QName("http://ws.coverity.com/v5", "DefectServiceService"));
    }
    ...
    public DefectService getDefectServicePort() {
        return super.getPort(new QName("http://ws.coverity.com/v5", "DefectServicePort"), DefectService.class);
    }
    ...
    public DefectService getDefectServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.coverity.com/v5", "DefectServicePort"), DefectService.class, features);
    }
