 ...
 * generated in the com.coverity.ws.v5 package. 
...
public class ObjectFactory {
    ...
    private final static QName _UpdateStream_QNAME = new QName("http://ws.coverity.com/v5", "updateStream");
    private final static QName _GetProjects_QNAME = new QName("http://ws.coverity.com/v5", "getProjects");
    private final static QName _GetTriageStores_QNAME = new QName("http://ws.coverity.com/v5", "getTriageStores");
    private final static QName _GetCheckerProperties_QNAME = new QName("http://ws.coverity.com/v5", "getCheckerProperties");
    private final static QName _GetGroups_QNAME = new QName("http://ws.coverity.com/v5", "getGroups");
    ...
    private final static QName _GetCommitStateResponse_QNAME = new QName("http://ws.coverity.com/v5", "getCommitStateResponse");
    private final static QName _GetGroup_QNAME = new QName("http://ws.coverity.com/v5", "getGroup");
    private final static QName _GetSnapshotInformationResponse_QNAME = new QName("http://ws.coverity.com/v5", "getSnapshotInformationResponse");
    private final static QName _CreateStreamInProject_QNAME = new QName("http://ws.coverity.com/v5", "createStreamInProject");
    private final static QName _CreateTriageStoreResponse_QNAME = new QName("http://ws.coverity.com/v5", "createTriageStoreResponse");
    private final static QName _GetAttribute_QNAME = new QName("http://ws.coverity.com/v5", "getAttribute");
    private final static QName _CreateUserResponse_QNAME = new QName("http://ws.coverity.com/v5", "createUserResponse");
    private final static QName _GetCommitState_QNAME = new QName("http://ws.coverity.com/v5", "getCommitState");
    private final static QName _DeleteComponentMapResponse_QNAME = new QName("http://ws.coverity.com/v5", "deleteComponentMapResponse");
    private final static QName _GetLicenseState_QNAME = new QName("http://ws.coverity.com/v5", "getLicenseState");
    private final static QName _UpdateUserResponse_QNAME = new QName("http://ws.coverity.com/v5", "updateUserResponse");
    private final static QName _GetGroupResponse_QNAME = new QName("http://ws.coverity.com/v5", "getGroupResponse");
    private final static QName _UpdateAttribute_QNAME = new QName("http://ws.coverity.com/v5", "updateAttribute");
    private final static QName _UpdateGroupResponse_QNAME = new QName("http://ws.coverity.com/v5", "updateGroupResponse");
    private final static QName _DeleteTriageStore_QNAME = new QName("http://ws.coverity.com/v5", "deleteTriageStore");
    private final static QName _DeleteSnapshotResponse_QNAME = new QName("http://ws.coverity.com/v5", "deleteSnapshotResponse");
    private final static QName _CreateRoleResponse_QNAME = new QName("http://ws.coverity.com/v5", "createRoleResponse");
    private final static QName _DeleteAttributeResponse_QNAME = new QName("http://ws.coverity.com/v5", "deleteAttributeResponse");
    ...
    private final static QName _GetLdapServerDomains_QNAME = new QName("http://ws.coverity.com/v5", "getLdapServerDomains");
    private final static QName _CreateAttributeResponse_QNAME = new QName("http://ws.coverity.com/v5", "createAttributeResponse");
    private final static QName _DeleteUserResponse_QNAME = new QName("http://ws.coverity.com/v5", "deleteUserResponse");
    private final static QName _GetComponentResponse_QNAME = new QName("http://ws.coverity.com/v5", "getComponentResponse");
    private final static QName _DeleteStream_QNAME = new QName("http://ws.coverity.com/v5", "deleteStream");
    ...
    private final static QName _UpdateProjectResponse_QNAME = new QName("http://ws.coverity.com/v5", "updateProjectResponse");
    private final static QName _GetDefectStatusesResponse_QNAME = new QName("http://ws.coverity.com/v5", "getDefectStatusesResponse");
    private final static QName _CreateComponentMapResponse_QNAME = new QName("http://ws.coverity.com/v5", "createComponentMapResponse");
    private final static QName _CopyStreamResponse_QNAME = new QName("http://ws.coverity.com/v5", "copyStreamResponse");
    private final static QName _CreateUser_QNAME = new QName("http://ws.coverity.com/v5", "createUser");
    private final static QName _UpdateTriageStoreResponse_QNAME = new QName("http://ws.coverity.com/v5", "updateTriageStoreResponse");
    private final static QName _UpdateUser_QNAME = new QName("http://ws.coverity.com/v5", "updateUser");
    private final static QName _GetAttributes_QNAME = new QName("http://ws.coverity.com/v5", "getAttributes");
    private final static QName _DeleteStreamResponse_QNAME = new QName("http://ws.coverity.com/v5", "deleteStreamResponse");
    private final static QName _DeleteUser_QNAME = new QName("http://ws.coverity.com/v5", "deleteUser");
    private final static QName _GetSnapshotsForStream_QNAME = new QName("http://ws.coverity.com/v5", "getSnapshotsForStream");
    private final static QName _GetSnapshotsForStreamResponse_QNAME = new QName("http://ws.coverity.com/v5", "getSnapshotsForStreamResponse");
    private final static QName _SetMessageOfTheDayResponse_QNAME = new QName("http://ws.coverity.com/v5", "setMessageOfTheDayResponse");
    private final static QName _GetSnapshotInformation_QNAME = new QName("http://ws.coverity.com/v5", "getSnapshotInformation");
    private final static QName _DeleteRoleResponse_QNAME = new QName("http://ws.coverity.com/v5", "deleteRoleResponse");
    ...
    private final static QName _GetSystemConfig_QNAME = new QName("http://ws.coverity.com/v5", "getSystemConfig");
    private final static QName _GetAllPermissions_QNAME = new QName("http://ws.coverity.com/v5", "getAllPermissions");
    private final static QName _SetMessageOfTheDay_QNAME = new QName("http://ws.coverity.com/v5", "setMessageOfTheDay");
    private final static QName _GetComponentMapsResponse_QNAME = new QName("http://ws.coverity.com/v5", "getComponentMapsResponse");
    private final static QName _DeleteTriageStoreResponse_QNAME = new QName("http://ws.coverity.com/v5", "deleteTriageStoreResponse");
    private final static QName _GetProjectsResponse_QNAME = new QName("http://ws.coverity.com/v5", "getProjectsResponse");
    private final static QName _CreateStream_QNAME = new QName("http://ws.coverity.com/v5", "createStream");
    private final static QName _GetComponent_QNAME = new QName("http://ws.coverity.com/v5", "getComponent");
    private final static QName _CreateGroupResponse_QNAME = new QName("http://ws.coverity.com/v5", "createGroupResponse");
    private final static QName _GetComponentMaps_QNAME = new QName("http://ws.coverity.com/v5", "getComponentMaps");
    private final static QName _GetUsers_QNAME = new QName("http://ws.coverity.com/v5", "getUsers");
    private final static QName _GetAttributesResponse_QNAME = new QName("http://ws.coverity.com/v5", "getAttributesResponse");
    private final static QName _GetMessageOfTheDayResponse_QNAME = new QName("http://ws.coverity.com/v5", "getMessageOfTheDayResponse");
    private final static QName _GetServerTimeResponse_QNAME = new QName("http://ws.coverity.com/v5", "getServerTimeResponse");
    private final static QName _CreateRole_QNAME = new QName("http://ws.coverity.com/v5", "createRole");
    private final static QName _Notify_QNAME = new QName("http://ws.coverity.com/v5", "notify");
    private final static QName _CreateStreamInProjectResponse_QNAME = new QName("http://ws.coverity.com/v5", "createStreamInProjectResponse");
    private final static QName _UpdateGroup_QNAME = new QName("http://ws.coverity.com/v5", "updateGroup");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.coverity.ws.v5
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetCheckerProperties }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v5", name = "getCheckerProperties")
    public JAXBElement<GetCheckerProperties> createGetCheckerProperties(GetCheckerProperties value) {
        return new JAXBElement<GetCheckerProperties>(_GetCheckerProperties_QNAME, GetCheckerProperties.class, null, value);
    }
