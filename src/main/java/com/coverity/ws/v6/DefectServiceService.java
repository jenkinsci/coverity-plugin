 ...
 * 
 */
@WebServiceClient(name = "DefectServiceService", targetNamespace = "http://ws.coverity.com/v6", wsdlLocation = "http://localhost:11121/ws/v6/defectservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DEFECTSERVICESERVICE_QNAME = new QName("http://ws.coverity.com/v6", "DefectServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:11121/ws/v6/defectservice?wsdl");
