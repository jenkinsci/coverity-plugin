...
public interface ConfigurationService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getAllIntegrityControlPermissions", targetNamespace = "http://ws.coverity.com/v6", className = "com.coverity.ws.v6.GetAllIntegrityControlPermissions")
    @ResponseWrapper(localName = "getAllIntegrityControlPermissionsResponse", targetNamespace = "http://ws.coverity.com/v6", className = "com.coverity.ws.v6.GetAllIntegrityControlPermissionsResponse")
